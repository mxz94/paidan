...
async function runOnce() {
  ...
  try {
    ...
    console.log(
              `[dispatch-auto-transfer] done pending72h=${dispatchSummary.pendingToSupervisorCount} sales72h=${dispatchSummary.salesOverdueToSupervisorCount} sales72hNoop=${dispatchSummary.salesNoopOverdueToSupervisorCount} skipped=${dispatchSummary.skippedNoSupervisorCount} notifyOK=${dispatchSummary.notifySentCount} notifyFail=${dispatchSummary.notifyFailedCount}`,
    );
    console.log(
